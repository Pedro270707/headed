...
public class IronGolemHeadEntityModel extends HeadedSkullBlockEntityModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -10.0F, -4.0F, 8.0F, 10.0F, 8.0F).uv(24, 0).cuboid(-1.0F, -3.0F, -6.0F, 2.0F, 4.0F, 2.0F), ModelTransform.NONE);
