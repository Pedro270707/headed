...
public class PhantomHeadEntityModel extends HeadedSkullBlockEntityModel {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-3.5F, -3.0F, -2.5F, 7.0F, 3.0F, 5.0F), ModelTransform.NONE);
        return TexturedModelData.of(modelData, 64, 64);
    }

    @Override
    public float[] getHeadSizeInPixels() {
        return new float[] {7.0f, 3.0f, 5.0f};
    }
