...
public class HeadedItems {
    ...
    public static final Item ENDERMAN_HEAD = registerItem("enderman_head", new VerticallyAttachableBlockItem(HeadedBlocks.ENDERMAN_HEAD, HeadedBlocks.ENDERMAN_WALL_HEAD, new FabricItemSettings().rarity(Rarity.UNCOMMON), Direction.DOWN));
